  ...
  return (
    <>
      <header
        ...
        className=" h-screen w-full left-0 bg-cover bg-center bg-no-repeat"
      >
        <div className="w-[340px] md:w-[600px] mx-auto absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2">
